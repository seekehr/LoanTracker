                                    ...
                                    <div key={notif.id} className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg p-4 flex items-start space-x-4 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="mt-3 flex flex-wrap gap-2 items-center">
                                                ...
                                                {/* Link Button (conditionally rendered) */}
                                                {notif.link && (
                                                    <a
                                                        href={notif.link}
                                                        target="_blank" // Open in new tab
                                                        rel="noopener noreferrer" // Security best practice
                                                        // Changed hover effect to background color
                                                        className={`inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background h-9 px-3 ${
                                                            parsed.actions ? 'ml-auto' : '' // Push to right if actions exist
                                                        } hover:bg-white dark:hover:bg-gray-100 hover:text-accent-foreground dark:hover:text-gray-900 transition-colors duration-200 ease-in-out`} // Changed hover, added text color hover, ensured transition
